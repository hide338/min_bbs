    ...
    <form action="" method="post">
      <dl>
        ...
        <dd>
          ...
          <input type="hidden" name="reply_post_id" value="<?php if(isset($_REQUEST['res'])){echo htmlspecialchars($_REQUEST['res'],ENT_QUOTES);}else{echo htmlspecialchars('0',ENT_QUOTES);} ?>" />
        </dd>
      </dl>
      <div>
        <p>
